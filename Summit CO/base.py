...
class BaseScraper(object):
	...
	def __init__(self):
		self.input_file_path = 'Summit County CO Open Cases by Duration and Type.csv'
		self.output_file_path = 'Results_Summit County CO Open Cases by Duration and Type.csv'
		self.buid_base_item()
